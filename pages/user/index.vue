...
async function fetchUserDetails() {
    try {
        ...
        if (_error.response.status === 500) {
            error.value = "An error occurred when fetching user details";
        }
    ...
    <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 sm:py-12 lg:px-8">
        <section class="mb-6 flex items-center justify-between">
            <div class="flex items-center justify-start"><span
                ...
                <h1 class="text-3xl leading-tight">Dashboard</h1>
            </div><a
                ...
                href="/user/profile" target="_blank" disabled="false"><span
                    class="inline-flex justify-center items-center w-6 h-6"> <svg viewBox="0 0 32 32"
                  ...
                  ">
                    ...
                    </svg></span><span class="px-1">Profile</span></a>
        </section>
                                ...
                                <div class="justify-start items-center block md:flex">
                                    ...
                                    <div class="flex items-center justify-center">
                                        <div class="text-center md:text-left overflow-hidden">
                                            ...
                                            <p class="text-gray-500 dark:text-slate-400">Dec 1, 2023 @ dare.concepcion
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="justify-start items-center block md:flex">
                                    ...
                                    <div class="flex items-center justify-center">
                                        <div class="text-center md:text-left overflow-hidden">
                                            ...
                                            <p class="text-gray-500 dark:text-slate-400">May 18, 2023 @ geovanni.kessler
                                            </p>
                                        </div>
                                    </div>
                                </div>
